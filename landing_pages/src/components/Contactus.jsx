            ...
            <ul className="mb-6">
              ...
              <li className="flex items-center mb-2 text-gray-600">
                ...
                <a href="mailto:redcupseriespvtltd@gmail.com" className="hover:underline">
                  techforeducation@gmail.com
                </a>
              </li>
              <li className="flex items-center text-gray-600">
                <IoMdPin className="mr-2" />
                <span>630 Churchill Drive Mt Pleasant Harare</span>
              </li>
              <li className="flex items-center mb-2 text-gray-600">
                    <RiWhatsappFill  className="mr-2" />
                    <a href="https://wa.me/263774095586" className="hover:underline" target="_blank" rel="noopener noreferrer">
                        WhatsApp
                    </a>
                </li>
            </ul>
